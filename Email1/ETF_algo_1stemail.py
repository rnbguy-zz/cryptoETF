#!/usr/bin/env python3
"""
python3.9 ETF_algo_1stemail.py --tp-pct 0.2 --sl-pct 0.12 --max-hold-days 21 --ambiguous-fallback sl-first --intraday-interval 1m --signals-file ../signals.txt --ask-to-buy-today --live-trade
"""

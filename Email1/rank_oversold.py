#!/usr/bin/env python3
"""
cd /home/ec2-user/pythonProject1 && /usr/local/bin/python3.9 /home/ec2-user/pythonProject1/rank_oversold.py --cache-dir /dev/shm/kline_cache
...
def main() -> int:
    ...
    predict_start_date = date(2026, 1, 31)
    train_end_date = date(2026, 1, 30)

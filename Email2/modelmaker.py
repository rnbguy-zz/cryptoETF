...
def send_email_with_analysis(body: str, df: Optional[pd.DataFrame] = None, directory: str = ".") -> None:
    ...
    msg["Subject"] = "Oversold Analysis Alert2"
...
DEFAULT_MODEL_BUNDLE_PATH = BASE_DIR / "models" / "default_model_76_3.joblib"
ROLLING_BUNDLE_PATH = BASE_DIR / "models" / "rolling_bundle_3.joblib"
...
def build_email_body(
    *,
    ...
    lines: List[str] = []
    lines.append("Oversold Analysis Alert - Email2")
    lines.append("=" * 60)
...
def main() -> int:
    ...
    if args.retrain:
        ...
        rolling_path = BASE_DIR / "models" / "rolling_bundle_3.joblib"
        default_path = BASE_DIR / "models" / "default_model_76_#.joblib"
